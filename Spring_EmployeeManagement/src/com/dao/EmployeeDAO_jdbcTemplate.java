...
public class EmployeeDAO_jdbcTemplate implements EmployeeDAO {
	...
	public int addEmployee(Employee employee) {
		...
		added = jdbcTemplate.update(insertData,employee.getName(),employee.getEmpId(),employee.getTechnology(),employee.getSalary());
		return added;
	}
	...
	public boolean updateEmployee(Employee employee) {
		...
		int num=jdbcTemplate.update(updateData,employee.getName(),employee.getSalary(),
				employee.getTechnology(),employee.getEmpId());
...
//		});
		...
		{
			return new Employee(set.getInt("empId"),set.getString("empName"),set.getString("technology"),set.getInt("salary"));
		});
//		
	...
	public List<Employee> findAllEMployees() {
		...
		List<Employee> employees = jdbcTemplate.query("select * from employee", new RowMapper<Employee>()
		{
			...
			public Employee mapRow(ResultSet set, int arg1) throws SQLException 
			{
				...
				emp.setTechnology(set.getString("technology"));
